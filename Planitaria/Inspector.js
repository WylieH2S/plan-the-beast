...
export function Inspector({ selectedItem, updateItem, multi }) {
  ...
  if (!open) return React.createElement("div", {
    ...
    React.createElement("button", { onClick: () => setOpen(true), style: { background: "#444", color: "#fff", padding: "6px" } }, "▶ Inspector")
  );
  ...
  return React.createElement("div", {
    ...
    React.createElement("button", { onClick: () => setOpen(false), style: { float: "right", background: "#333", color: "#fff", border: "none" } }, "✕"),
